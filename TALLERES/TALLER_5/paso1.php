...
// 9. Función para contar cuántas ciudades comienzan con una letra específica
...
echo "Número de ciudades que comienzan con 'M': " . contarCiudadesPorInicial($ciudades, 'M') . "\n";
?>
